        ...
        $("#bt_confirm").click(function(){
            ...
            $.ajax({
                    ...
                    success: function(data){
                                ...
                                {
                                    $("#changepassword").hide();
                                    $(".modal-body").html('Password changed succesfully.');
                                    $("#modalbutton").click();                                }                               
                        },
                 });
        });
            ...
            $.ajax({
                    ...
                    success: function(data){
                                    ...
                                    else
                                    {
                                        ...
                                        $("#modalbutton").click();
                                        setTimeout(function(){window.location.href="selleraccount.php";}, 2000);  
                                    }
                        },
                 });
        });
	...
	<div id="pageWrapper">
        ...
        <!-- Modal -->
            ...
            <?php 
                ...
                $sql = "SELECT phonenumber, address, firstname, lastname, email FROM sellers WHERE username = '{$username}' ";
