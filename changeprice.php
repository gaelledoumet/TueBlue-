					...
					<div style="margin-top:150px" class="col-12 col-lg-6 order-lg-3">
						...
						<div class="productTextHolder overflow-hidden">
							...
							<ul class="list-unstyled productInfoDetail mb-5 overflow-hidden">
								...
								<li class="mb-2">Old price: <span><?=$row[2]?>$</span></li>

							</ul>
							<div class="holder overflow-hidden d-flex flex-wrap mb-6">
								<div class="form-group">
								<label for="new_price"><strong>Enter the new price</strong></label>
								<input style=" border-width: 1.5px;color:white;" id="new_price" type="text" class="form-control" id="exampleInputFirst" placeholder="in USD">
								</div>
								<button id="add_price" type="button" class="btn btnTheme btnShop fwEbold text-white py-3 px-4" style="display: inline-block; height:60px; margin-top:30px; margin-left:10px">Change price</button>                    
