<?php session_start(); 
    ...
    {
        if(!isset($_SESSION["businessowner"]))
        {
            ...
            $.ajax({
                    ...
                    success: function(data){
                                    ...
                                    else
                                    {
                                        ...
                                        $("#modalbutton").click();
                                        setTimeout(function(){window.location.href="businessowneraccount.php";}, 2000);  
                                    }
                        },
                 });
        });
    ...
    <header id="header" class="position-relative">
									...
									<div class="collapse navbar-collapse" id="navbarNav">
										<ul class="navbar-nav mx-auto text-uppercase d-inline-block">
											...
											<li class="nav-item dropdown active">
												<a class="d-block" role="button" aria-haspopup="true" aria-expanded="false" href="businessowneraccount.php">My account</a>
											</li>
											<li class="nav-item dropdown">
        ...
        <!-- Modal -->
            ...
            <?php 
                ...
                $sql = "SELECT phonenumber, address, fullname, email FROM businessowners WHERE username = '{$username}' ";
			...
			<section id="NewArrival" class="featureSec container overflow-hidden pt-xl-12 pb-xl-9 pt-lg-10 pb-lg-4 pt-md-8 pb-md-2 pt-5">
				<div class="row">
                    ...
                    <div class="container" style="text-align:center">
                            <button id="change_password" class="btn btnTheme btnShop fwEbold text-white py-3 px-3" style="margin-right:20px">Change <br> Password</button>
                            <button id="change_number" class="btn btnTheme btnShop fwEbold text-white py-3 px-3"style="margin-right:20px">Change <br> Phone Number</button>
                            <button id="change_address" class="btn btnTheme btnShop fwEbold text-white py-3 px-3"style="margin-right:20px">Change <br> Address</button>
                            <br>
                            <br>
                    </div>
                    <br>
