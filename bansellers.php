        ...
        $(document).ready(function($){
            ...
            $(".ban").click(function()
            {
				$.ajax({
						...
						success: function(data){
							$(".modal-body").html("seller banned");
							$("#modalbutton").click();
							setTimeout(function(){window.location.href="bansellers.php";}, 3000);
							}, 
				}); 
            });
			$(".permit").click(function()
            {
				$.ajax({
						...
						success: function(data){
							$(".modal-body").html("seller permitted");
							$("#modalbutton").click();
							setTimeout(function(){window.location.href="bansellers.php";}, 3000);
  ...
  <body>
	...
	<!-- Modal -->
        ...
        <header class="col-12 mainHeader mb-7 text-center">
                    <h2 class="headingIV playfair fwEblod mb-4">Sellers accounts</h2> 
				...
				<div class="row">
					...
					<div class="col-12 table-responsive mb-xl-22 mb-lg-20 mb-md-16 mb-10">
						...
						<table id="myTable" class="table ">
							<thead>
							<tr>
								<th style="text-align:center"><strong>Username</strong></td>
								<th style="text-align:center"><strong>Phone number</strong></td>
								<th style="text-align:center"><strong>Address</strong></td>
								<th style="text-align:center"><strong>Name</strong></td>
								<th style="text-align:center"><strong>email</strong></td>
								<th style="text-align:center"><strong>Ban flag</strong></td>
								<th style="text-align:center"><strong></strong></td>
							</tr>
							</thead>
							<tbody>
						<?php
						...
						$stmt2=$mysqli->prepare("SELECT username, phonenumber, address, firstname, lastname, email FROM sellers");
						$stmt2->execute();
						$stmt2->store_result();
						$stmt2->bind_result($username, $phonenumber, $address, $firstname, $lastname, $email);
