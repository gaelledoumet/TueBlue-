...
header('Content-Type:text/plain');
        ...
        {   
           ...
           if ($count1 != 0 )
            ...
            if($count11211==0 && $count10211==0 && $count13211==0 && $count1321==0 && $count1121==0 && $count1021==0 && $count == 0 && $count10 == 0 && $count11 == 0 && $count1 == 0 && $count0 == 0 && $count13 == 0 && $count102 == 0 && $count101 == 0 && $count111 == 0 && $count112 == 0 && $count131 == 0 && $count132 == 0)
            {
                    $fullname = $fnamee1 . " " . $lnamee1;

                    $stmt2 = $mysqli->prepare("INSERT INTO employees (username, phonenumber, address, fullname, email, password) VALUES(?, ?, ?, ?, ?, ?)");
